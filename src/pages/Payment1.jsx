...
export default function () {
        ...
        <div className="frame-559">
          ...
          <div className="component-1">
            ...
            <img
              ...
              src="material-symbols-navigate-next-2@2x.svg"
  ...
  return (
    <>
      ...
      />
      <link rel="stylesheet" type="text/css" href="apply-payment.css" />
      <input
        type="hidden"
        id="anPageName"
        name="page"
      ...
      <div className="container-center-horizontal">
        <div className="apply-payment screen">
          <div className="group-438">
            <div className="overlap-group2">
              <div className="group-184">
                ...
                <img className="line-79" src="line-79-8@1x.svg" alt="Line 79" />
              </div>
              <div className="component-13">
                <img
                  className="icon-home icon"
                  src="home-fill0-wght400-grad0-opsz48-1-8@2x.svg"
                  alt="icon-home"
                />
              ...
              <div className="component-14">
                <img
                  ...
                  src="draft-fill1-wght400-grad0-opsz48--1--1-8@2x.svg"
              ...
              <div className="component-22">
                <img
                  ...
                  src="logout-fill0-wght400-grad0-opsz48-1-8@2x.svg"
              ...
              <div className="component-13-1">
                <img
                  ...
                  src="import-contacts-fill0-wght400-grad0-opsz48-1-8@2x.svg"
              ...
              <div className="component-21">
                <img
                  ...
                  src="paid-fill0-wght400-grad0-opsz48-1-8@2x.svg"
              ...
              <div className="component-23">
                <img
                  ...
                  src="person-fill0-wght400-grad0-opsz48-1-8@2x.svg"
                  alt="icon-user"
                />
              ...
              <div className="component-18">
                <img
                  ...
                  src="contact-support-fill0-wght400-grad0-opsz48--1--1-8@2x.svg"
              ...
              <div className="component-19">
                <img
                  ...
                  src="call-fill0-wght400-grad0-opsz48--1--1-8@2x.svg"
                  alt="icon-call"
                />
              ...
              <div className="component-24">
                <img
                  ...
                  src="settings-fill0-wght400-grad0-opsz48-1-8@2x.svg"
                  alt="icon-settings"
                />
                      ...
                      <div className="group-402">
                        <div className="component-92">
                          <img
                            ...
                            src="material-symbols-check-small-2@2x.svg"
                              ...
                              {/* <div className="frame-55">
                                <div className="frame-55-2 frame-55-3">
                                  <div className="component-102-1">
                                    <img
                                      ...
                                      src="material-symbols-check-small-3@2x.svg"
                                      alt="material-symbols:check-small"
                                    />
                                  </div>
                                </div>
                                <div className="frame-59">
                                  <div className="component-38">
                                    ...
                                    <img
                                      className="verified_fill1_wght400_grad0_opsz48-1"
                                      src="verified-fill1-wght400-grad0-opsz48-1-1@2x.svg"
                                      alt="verified_FILL1_wght400_GRAD0_opsz48 1"
                                    />
                                  </div>
                                </div>
                                <div className="component-1">
                                  ...
                                  <img
                                    className="material-symbolsnavigate-next"
                                    src="material-symbols-navigate-next@2x.svg"
                                    alt="material-symbols:navigate-next"
                                  />
                                </div>
                                <div className="component">
                              ...
                              {/* <div className="frame-558">
                                <div className="frame-55-2 frame-55-3">
                                  <div className="component-102-1">
                                    <img
                                      className="material-symbolscheck-small"
                                      src="material-symbols-check-small-4@2x.svg"
                                      alt="material-symbols:check-small"
                                    />
                                  </div>
                                </div>
                                <div className="frame-59">
                                  <div className="component-38">
                                    ...
                                    <img
                                      className="verified_fill1_wght400_grad0_opsz48-1"
                                      src="verified-fill1-wght400-grad0-opsz48-1-2@2x.svg"
                                      alt="verified_FILL1_wght400_GRAD0_opsz48 1"
                                    />
                                  </div>
                                </div>
                                <div className="component-1">
                                  ...
                                  <img
                                    className="material-symbolsnavigate-next"
                                    src="material-symbols-navigate-next-1@2x.svg"
                                    alt="material-symbols:navigate-next"
                                  />
                                </div>
                                <div className="component">
                      ...
                      {/* <div className="frame-573">
                        <div className="frame-449">
                          <img
                            ...
                            src="ion-triangle-sharp-20@2x.svg"
                        ...
                        <img
                          ...
                          src="ion-triangle-sharp-19@2x.svg"
                          alt="ion:triangle-sharp"
                        />
                      </div> */}
                    </div>
                    {/* <div className="frame-572">
                      <div className="frame-449">
                        <img
                          ...
                          src="ion-triangle-sharp-18@2x.svg"
                          alt="ion:triangle-sharp"
                        />
                      ...
                      <img
                        ...
                        src="ion-triangle-sharp-17@2x.svg"
                        alt="ion:triangle-sharp"
                      />
                    </div> */}
                  </div>
          ...
          <img className="line-108" src="line-108@2x.svg" alt="Line 108" />
        </div>
      </div>
    </>
  );
