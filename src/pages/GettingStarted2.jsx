...
export default function GettingStarted2() {
  return (
    <>
      ...
      />
      <link rel="stylesheet" type="text/css" href="apply-getting-started.css" />
      <input
        type="hidden"
        id="anPageName"
        name="page"
        defaultValue="apply-getting-started"
      />
      <div className="container-center-horizontal-gettingStarted2">
        <div className="apply-getting-started screen-gettingStarted2">
          <div className="group-440">
            <div className="overlap-group1">
              <div className="group-184">
                ...
                <img className="line-79" src="line-79-3@1x.svg" alt="Line 79" />
              </div>
              <div className="component-13">
                <img
                  className="icon"
                  src="home-fill0-wght400-grad0-opsz48-1-3@2x.svg"
                  alt="icon-home"
                />
              ...
              <div className="component-13-1">
                <img
                  ...
                  src="import-contacts-fill0-wght400-grad0-opsz48-1-3@2x.svg"
              ...
              <div className="component-23">
                <img
                  className="icon"
                  src="person-fill0-wght400-grad0-opsz48-1-3@2x.svg"
                  alt="icon-user"
                />
              ...
              <div className="component-19">
                <img
                  className="icon"
                  src="call-fill0-wght400-grad0-opsz48--1--1-3@2x.svg"
                  alt="icon-call"
                />
          ...
          <div className="group-439">
            <div className="frame-616">
              <div className="component-33-1">
                <div className="researchers-1 researchers-3 inter-semi-bold-white-14px">
                  Next
                </div>
              </div>
            </div>
            ...
            <div className="frame-40 inter-normal-slate-gray-14px">
              <div className="frame">
                ...
                <div className="frame-290-1">
                  <div className="researchers-2 researchers-3">Researchers</div>
                </div>
              </div>
              <div className="frame">
            ...
            <div className="component-85">
                      ...
                      <div className="frame inter-normal-slate-gray-14px">
                        ...
                        <div className="frame-290">
                          <div className="group-234">
                            <div className="x1234emailcom">1234@email.com</div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="group-317">
                  <div className="group-298">
                    ...
                    <div className="frame-290-3">
                      <div className="group-234-2 group-234-5">
              ...
              <div className="frame-40">
                <div className="frame-304">
                  <div className="frame inter-normal-slate-gray-14px">
                    ...
                    <div className="frame-290">
                      <div className="group-234">
                        <div className="x1234emailcom-7">1234@email.com</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="frame inter-normal-slate-gray-14px">
                  ...
                  <div className="frame-290-4">
                    <div className="group-234-3 group-234-5">
                      <div className="select-a-country">Select a country</div>
                    </div>
                    <img
                      className="frame-607"
                      src="frame-607-9@2x.svg"
                      alt="Frame 607"
                    />
                  </div>
                </div>
              ...
              <div className="frame-40">
                <div className="frame">
                  ...
                  <div className="frame-290">
                    <div className="group-234-1 group-234-5">
              ...
              <div className="group-299">
                <div className="frame">
                  ...
                  <div className="frame-290-6">
                    <div className="group-234-4 group-234-5">
                      <div className="x1234emailcom-7 inter-bold-slate-gray-14px">
                        1234@email.com
                      </div>
                    </div>
                      ...
                      <div className="group-415">
                        <div className="component-92">
                          <img
                            ...
                            src="material-symbols-check-small@2x.svg"
