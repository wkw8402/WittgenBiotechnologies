  ...
  return (
    <>
      ...
      <link
        rel="stylesheet"
        type="text/css"
        href="apply-metadatabase-input-manual-input.css"
      />
      <input
        type="hidden"
        id="anPageName"
        name="page"
        defaultValue="apply-metadatabase-input-manual-input"
      />
      <div className="container-center-horizontal-manualData">
        <div className="apply-metadatabase-input-manual-input screen-manualData">
          <div className="group-438">
            <div className="overlap-group1">
              <div className="group-184">
                ...
                <img className="line-79" src="line-79-7@1x.svg" alt="Line 79" />
              </div>
              <div className="component-13 component-1">
                <img
                  className="icon"
                  src="home-fill0-wght400-grad0-opsz48-1-7@2x.svg"
                  alt="icon-home"
                />
                <a href="/dashboard">
              ...
              <div className="component-14 component-1">
                <img
                  ...
                  src="draft-fill1-wght400-grad0-opsz48--1--1-7@2x.svg"
              ...
              <div className="component-22 component-1">
                <img
                  ...
                  src="logout-fill0-wght400-grad0-opsz48-1-7@2x.svg"
              ...
              <div className="component-13-1">
                <img
                  ...
                  src="import-contacts-fill0-wght400-grad0-opsz48-1-7@2x.svg"
              ...
              <div className="component-21 component-1">
                <img
                  ...
                  src="paid-fill0-wght400-grad0-opsz48-1-7@2x.svg"
              ...
              <div className="component-23 component-1">
                <img
                  className="icon"
                  src="person-fill0-wght400-grad0-opsz48-1-7@2x.svg"
                  alt="icon-user"
                />
              ...
              <div className="component-18 component-1">
                <img
                  ...
                  src="contact-support-fill0-wght400-grad0-opsz48--1--1-7@2x.svg"
              ...
              <div className="component-19 component-1">
                <img
                  className="icon"
                  src="call-fill0-wght400-grad0-opsz48--1--1-7@2x.svg"
                  alt="icon-call"
                />
              ...
              <div className="component-24 component-1">
                <img
                  className="icon"
                  src="settings-fill0-wght400-grad0-opsz48-1-7@2x.svg"
                  alt="icon-settings"
                />
              ...
              <div className="frame-213">
                ...
                >
                  <div className="component-31 component-1">
                    <div className="researchers inter-semi-bold-white-14px2">
                      Save &amp; Exit
                    </div>
                  </div>
                </a>
            ...
            <div className="frame-616">
              ...
              <a href="/database_input_1" style={{ textDecoration: "none" }}>
                <div className="component-33-1">
                  <div className="researchers-3 inter-semi-bold-white-14px2">
                    Next
                  </div>
                </div>
              </a>
              ...
              <div className="group-347">
                <div className="frame">
                  <div className="frame">
                          ...
                          <div className="frame-454">
                            <a href="/metabase_input_1">
                              <div className="frame-214">
                                <div className="import-excel-file inter-semi-bold-blue-dianne-16px">
                                  Import Excel file
                                </div>
                              </div>
                            </a>
                            <div className="frame-215">
                              <div className="manual-data-input inter-semi-bold-white-16px">
                                Manual data input
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="frame-541-1">
                      <div className="frame-539">
                        <div className="frame-453">
                          <div className="frame-532" />
                          <div className="component">
                            <div className="sample inter-semi-bold-white-14px-22">
                              <span className="inter-semi-bold-slate-gray-14px">
                                Sample{" "}
                              </span>
                              <span className="inter-semi-bold-red-14px">
                                *
                              </span>
                            </div>
                          </div>
                          <div className="component">
                            <div className="height inter-semi-bold-white-14px-22">
                              <span className="inter-semi-bold-slate-gray-14px">
                                Height{" "}
                              </span>
                              <span className="inter-semi-bold-red-14px">
                          ...
                          <div className="component-99 component-1">
                            <div className="blood-type inter-semi-bold-white-14px-22">
                              <span className="inter-semi-bold-slate-gray-14px">
                                Blood type{" "}
                              </span>
                              <span className="inter-semi-bold-red-14px">
                        ...
                        <div className="frame-538">
                          ...
                          {/* <div className="frame-53">
                            ...
                            <div className="component-43 component-1">
                              <div className="group-369">
                                ...
                                <img
                                  ...
                                  src="mdi-warning-circle-outline-2@2x.svg"
                            ...
                            <div className="component">
                              <div className="number inter-normal-tundora-14px">
                                2
                              </div>
                            </div>
                            <div className="component">
                          ...
                          {/* <div className="frame-537">
                            ...
                            <div className="component-49 component-1">
                              <div className="group-369">
                                ...
                                <img
                                  className="mdiwarning-circle-outline"
                                  src="mdi-warning-circle-outline-3@2x.svg"
                                  alt="mdi:warning-circle-outline"
                                />
                              </div>
                            </div>
              ...
              {/* <div className="frame-450">
                <div className="frame-449">
                  <img
                    ...
                    src="ion-triangle-sharp-14@2x.svg"
                ...
                <img
                  ...
                  src="ion-triangle-sharp-13@2x.svg"
                  alt="ion:triangle-sharp"
                />
              </div> */}
            </div>
            {/* <div className="frame-449-1">
              <div className="frame-449">
                <img
                  ...
                  src="ion-triangle-sharp-16@2x.svg"
                  alt="ion:triangle-sharp"
                />
              ...
              <img
                ...
                src="ion-triangle-sharp-15@2x.svg"
                alt="ion:triangle-sharp"
              />
            </div> */}
          </div>
