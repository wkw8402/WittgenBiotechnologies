        ...
        <div class="frame-695">
            ...
            <div class="frame-683">
              <a href="my-profile.html">
                <div class="frame-468">
                  ...
                  <div class="my-profile-2 my-profile-3 inter-semi-bold-blue-dianne-15px">My profile</div>
                </div></a
              >
              <div class="frame-466">
                <img class="icon-1" src="icon-14.svg" alt="icon" />
                <div class="change-password-1 change-password-3 inter-semi-bold-white-15px">Change password</div>
              </div>
              <div class="frame-469">
                <img
          ...
          <div class="application">
            <div class="component-85">
              <div class="frame">
                <div class="frame-496">
                  <div class="change-password-2 change-password-3 inter-semi-bold-blue-dianne-27px">
                    Change password
                  </div>
                </div>
                <a href="my-profile.html">
                    ...
                    <div class="group">
                      <div class="frame">
                        <div class="group">
                          <div class="group-298">
                            <div class="frame-301">
                              <div class="x-password inter-normal-slate-gray-10-5px">Current password</div>
                    ...
                    <div class="group">
                      <div class="frame">
                        <div class="group">
                          <div class="group-298">
                            <div class="frame-301">
                              <div class="x-password inter-normal-slate-gray-10-5px">New password</div>
                              <div class="frame-290"></div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="group">
                      <div class="frame">
                        <div class="group">
                          <div class="group-298">
                            <div class="frame-301">
                              <div class="x-password inter-normal-slate-gray-10-5px">Re-enter new password</div>
                              <div class="frame-290"></div>
                            </div>
                          </div>
                        </div>
              ...
              <div class="frame-551">
                <div class="frame-438">
                  <div class="frame-445">
                    ...
                    />
                    <div class="password-security inter-semi-bold-milano-red-8-2px">Password security</div>
                  </div>
                  <p class="your-password-must-b inter-normal-black-10-5px">
                ...
                <div class="frame-438-1">
                  <div class="password">
                    <div class="frame-63">
                      ...
                      <div class="address inter-semi-bold-black-14px">8 or more characters</div>
                    </div>
                    <div class="frame-63">
                      <div class="done_fill0_wght400_grad0_opsz48-1-2">
                        <div class="ellipse-25"></div>
                      </div>
                      <p class="mixture-of-letters-and-numbers inter-semi-bold-black-14px">
                    ...
                    <div class="frame-63">
                      ...
                      <p class="mixture-of-upper-and-lowercase inter-semi-bold-black-14px">
                    ...
                    <div class="frame-63">
                      ...
                      <div class="special-characters inter-semi-bold-black-14px">Special characters</div>
                    </div>
                  </div>
                </div>
              </div>
